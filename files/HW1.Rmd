...
ggplot(secondhandauto, aes(x=AY,y=`2020,00`,group=AY) )+
...
In general, it can be said that the graphs of the two data are related to each other. The similarity between the graphics is very visible, especially in summer.
...
ggplot(dollarsearch, aes(x=Tarih, y=Sayı,group=Yıl) )+
  ...
  labs(title ="Search Analysis of 'Dolar Kaç' in Google Search", 
       x = "Months over 2012-2019",
       y = "Amount of search") +
  theme_minimal() +theme(axis.text.x = element_text(angle = 90, hjust = 1))+ theme(plot.title = element_text(size = 15, hjust = 0.5))


ggplot(dollarrate, aes(x=Tarih,y=`USD/TL`,group=Yıl) )+
  geom_boxplot(aes(fill=Yıl))+scale_fill_gradient(low="wheat",high="wheat4")+
...
ggplot(sigaravergisi, aes(x=Ay, y=Sayı,group=Yıl) )+
  geom_boxplot(aes(fill=Yıl))+scale_fill_gradient(low="paleturquoise",high="paleturquoise4")+
  labs(title ="Search Analysis of 'sigara vergisi' in Google Search", 
       x = "Months over 2013 January-2020 June",
       y = "Amount of search") +
  theme_minimal() +theme(axis.text.x = element_text(angle = 90, hjust = 1))+ theme(plot.title = element_text(size = 15, hjust = 0.5))

ggplot(ozeltuketimvergisi, aes(x=Ay, y=Sayı,group=Yıl) )+
  geom_boxplot(aes(fill=Yıl))+scale_fill_gradient(low="paleturquoise",high="paleturquoise4")+
...
ggplot(sigara, aes(x=Tarih, y=fiyat,group=Yıl) )+
  geom_boxplot(aes(fill=Yıl))+scale_fill_gradient(low="paleturquoise",high="paleturquoise4")+
