...
ggplot() +
  ...
  labs(title = "Predicted vs. Actual Hourly Electricity Consumption in Turkey", 
       x = "Date Index",
       y = "Consumption (mWh)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
...
##   Code
The RMD File can be found [Here](https://bu-ie-360.github.io/fall20-edakocakarin/files/IE360Project-Group6.Rmd).